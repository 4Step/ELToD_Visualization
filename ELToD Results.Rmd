...
map <- leaflet() %>%
      ...
      addPolylines(data = shapeData_accessLinks, stroke = TRUE, smoothFactor = 1, weight = 5, 
                  color = "orange", group = "On Ramps") %>%
      addPolylines(data = shapeData_egressLinks, stroke = TRUE, smoothFactor = 1, weight = 5, 
...
if('PULLLINK' %in% colnames(shapeData@data)) {
    ...
    map <- map %>% 
            addPolylines(data = shapeData_pulllinks, 
                         stroke = TRUE, smoothFactor = 1, weight = 5, 
