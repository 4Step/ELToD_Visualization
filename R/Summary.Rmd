...
# Old policy
x_old <- x %>% filter(Policy == policy[1], Year == 2020)
...
# Old policy
x_old <- x %>% filter(Policy == policy[1], Year == 2040)
...
```{r}
# New policy
x_new <- x %>% filter(Policy == policy[2], Year == 2020)
...
# New policy
x_new <- x %>% filter(Policy == policy[2], Year == 2040)
